...
public:
    ...
    VkImageView GetImageView(std::uint32_t index) const { return swapchain_image_views_[index].get(); }
...
private:
    ...
    std::vector<VulkanSharedObject<VkImageView>> swapchain_image_views_;
